def gs_nodeblicense(txt_data: list, gslist_data: list, dt_col: dict, moc: str):
    gs_result = []
    ...
    for raw_data in txt_data:
        ...
        NodeB_license = u_data[dt_col.get("NodeBFunctionId", 2)]
        if NodeB_license == -1:
        ...
        for gs_data in gslist_data:
            ...
            if NodeB_license == u_data[dt_col.get("NodeBFunctionId", 2)]:
                moc_string = "NodeBFunction"
            else:
                moc_string = "SystemFunctions"

            gs_data = [
                NodeId,
                moc_string,
                moc_string + "=" + NodeB_license,
                param,
                oss_value,
                baseline_value,
                compliance,
